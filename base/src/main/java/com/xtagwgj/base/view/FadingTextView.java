...
/**
 * changes its content automatically every few seconds
 * Created by xtagwgj on 2017/11/28.
 */
...
public class FadingTextView extends android.support.v7.widget.AppCompatTextView {
     ...
     */
    private void init() {
        fadeInAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.text_fadein);
        fadeOutAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.text_fadeout);
        handler = new Handler();
        isShown = true;
    }
